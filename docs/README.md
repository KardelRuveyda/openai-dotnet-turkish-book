...
9. [OPEN AI ile Büyük Dil Modeli(LLM)](OPENAIwithLLM.md#open-ai-ile-büyük-dil-modeli-(llm)
...
11. [OpenAI ile Azure Arasındaki İlişki?](OpenAIwithAzure.md#openai-ile-azure-arasındaki-i̇lişki)
